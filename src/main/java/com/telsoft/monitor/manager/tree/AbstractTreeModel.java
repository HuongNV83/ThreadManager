 ...
 * @version 1.0
 */
public class AbstractTreeModel implements TreeModel {
     ...
     */
    public AbstractTreeModel(TreeNode root, AppContext context) {
        super();
        this.root = root;
    ...
    public void removeNodeFromParent(MutableTreeNode node, MutableTreeNode parent) {
        if (parent == null) {
